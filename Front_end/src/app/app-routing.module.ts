...
const routes: Routes = [
  ...
  { path: 'vendeur', component: VendeurComponent, canActivate: [AuthGuardService], data: { roles: ['admin'] } }, // Bloque l'accès à la page "Vendeur" pour les utilisateurs sans le rôle "admin"
